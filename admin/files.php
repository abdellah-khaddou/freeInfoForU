...
********************************************************-->
             <div style="overflow:auto">
                <table id="myTable" style="display: inline-table" class="table table-responsive table-hover  table-striped table-bordered shadow" cellspacing="0" width="100%">
                    <thead>
                        <tr>
...
***********************************************-->
            ...
            <div id="id01" class="modal" style="font-size: 16px;top:40px">
                <form class="modal-content" style="width: 50%;height: auto;">
                    <div class="d-flex flex-column" style="/*height: 21%;*/">
                        ...
                        <div class="container" style="width: 95%;height: 100%;">
                            ...
                            <input class="form-control" type="text" placeholder="Veuillez enter le nom de fichier " name="nom_fich" required>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="inputGroupSelect02" name="filier" required>
                                    <option value="">Choosir le module...</option>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="inputGroupSelect02" name="modul" required>
                                    <option value="">Choosir le filièr...</option>
                                    <option value="1">Mecanique</option>
                                    <option value="2">Analyse 1</option>
                                    <option value="3">Thermodinamique</option>
                                    <option value="4">Thermochimie</option>
                                </select>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="inputGroupSelect02" name="resp" required>
                                    <option value="">Choosir la respensable...</option>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select" id="inputGroupSelect02" name="nom_paye" required>
                                   <!-- <option value="">Choosir le payé correspondent...</option>  -->
...
***********************************************-->
            ...
            <div id="id02" class="modal" style="font-size: 16px;top:40px">
                ...
                <form class="modal-content" style="width: 50%;height: auto;">
                    ...
                    <div class="d-flex flex-column" style="/*height: 21%;*/">
                        ...
                        <div class="container" style="width: 95%;height: 100%;">
                            <label for="uname"><b>Nom de module :</b></label>
                            <input class="form-control" type="text" value="Cour chapitr I" name="nom_m" required >
...
***********************************************-->
            ...
            <div id="id03" class="modal" style="font-size:16px;width:100%;top:40px">
                <form class="modal-content animate" style="width: 52%;height: 320px;">
                    ...
                    <div class="container" style="width:auto;">
                        <label><b>Voulez-vous vraiment supprimer ce fichier ? </b></label>
